...
rho_width_hel_sqrt[res_num][i_hro][i_hnu] = rho_width_hel_sqrt[res_num][i_hro][i_hnu] + A*B*sqrt((2.*RHO_NU_MOM+1.)/(2.*res_j[res_num]+1.))*sqrt(res_width[res_num]*BR_RHO_LS[res_num][(RHO_NU_MOM-(max%2))/2][i_s]*factor_centrifugal[res_num][(RHO_NU_MOM-(max%2))/2][i_s]);
...
ERHO_res = (res_mass[res_num]*res_mass[res_num]+M12*M12-MP*MP)/(2.*res_mass[res_num]);
