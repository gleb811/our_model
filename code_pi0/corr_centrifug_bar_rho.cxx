...
ERHO_run = (res_mass[res_num]*res_mass[res_num]+SRHO_run[i]-MN*MN)/(2.*res_mass[res_num]);
...
Bess_rho_mom = abs(Bessel->Eval((P4_RHO.Vect().Mag())*R_INTERACTION));
Neum_rho_mom = abs(Neumann->Eval((P4_RHO.Vect().Mag())*R_INTERACTION));
Bess_rho_mom_res = abs(Bessel->Eval(P_RHO_mag_res*R_INTERACTION));
Neum_rho_mom_res = abs(Neumann->Eval(P_RHO_mag_res*R_INTERACTION));
...
BR_RHO_LS[res_num][(Int_t(RHO_NU_MOM-res_parity[res_num]))/2][0] = BR_RHO_LS[res_num][(Int_t(RHO_NU_MOM-res_parity[res_num]))/2][0]*factor;
BR_RHO_LS[res_num][(Int_t(RHO_NU_MOM-res_parity[res_num]))/2][1] = BR_RHO_LS[res_num][(Int_t(RHO_NU_MOM-res_parity[res_num]))/2][1]*factor;
