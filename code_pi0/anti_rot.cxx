...
//Here all derivations are performed via special root functions. If you need further level of explanation please see anti_rot_explanation, where all calculations are shown in more details and rotations are performed via matrices.
 ...
 void anti_rot(Float_t W, Float_t Q2, Float_t M12, Float_t M23, Float_t theta_hadr, Float_t alpha_hadr, Float_t phi_hadr, Float_t m1, Float_t m2, Float_t m3, TLorentzVector &P4_1, TLorentzVector &P4_2, TLorentzVector &P4_3) {




//Energy of virtual photon is CMS-frame
Float_t E_gamma = (W*W-Q2-MN*MN)/2./W;
//cout << MP << "\n";
...
P4_P_ini.SetXYZT(0,0,-P4_gamma[2],sqrt(MN*MN+P4_gamma[2]*P4_gamma[2]));
