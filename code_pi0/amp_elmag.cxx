...
E_gamma_res_cms = (res_mass[res_num]*res_mass[res_num]-Q2-MN*MN)/2./res_mass[res_num];
...
amp_gam_nu_to_res_pointer[0] =amp_gam_nu_to_res_pointer[0]* Double_t(W/res_mass[res_num]*sqrt((8.*MN*res_mass[res_num]*q_gamma_res_cms)/(4.*M_PI*alph_const)));
